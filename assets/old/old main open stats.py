...
def ShowStats():
    os.startfile(os.path.dirname(f"{os.getcwd()}\\assets\\stats\\scores.png"))
...
show_stats_button = tk.Button(root, text="Show Stats", font=DEFAULT_FONT, command=ShowStats)
show_stats_button.place(x=(SCREEN_WIDTH/2), y=470, anchor="n")
